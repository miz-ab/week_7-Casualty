...
class Df_clean:
    ...
    def drop_rows(self, columns):
        '''Drop Rows of specified columns, which contain null values apply it on columns with small number of nulls'''
    ...
    def fill_catagorical_column(self, column):
        '''Return DataFrameFill Null Value of catagorical columns with Mode'''
    ...
    def fill_numerical_column(self, column):
        ''' Reuturn DataFrame with Numerical null values filled with  mean or median depending on the skewness of the column'''
    ...
    def fill_numerical_columns(self, columns):
        ''' Fill Numerical multiple numerical columns with median and mode depending on their skewness.'''
        for column in columns:
